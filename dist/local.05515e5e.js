...
})({"bnjRI":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "75cb687905515e5e";
"use strict";
...
},{}],"hQ2df":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setup", ()=>setup);
parcelHelpers.export(exports, "localAdapter", ()=>localAdapter);
'use strict';
...
const setup = async ({ data, ...options })=>localAdapter(data, options);
const localAdapter = (initialData = {}, options = {})=>{
    const store = {};
    const listeners = {};
    ...
    const getTable = (name)=>{
        if (!store[name]) {
            ...
            else store[name] = initialData[name] || [];
        }
        return store[name];
    };
    const save = (name)=>{
        ...
        } catch  {} // expected: localStorage unavailable in SSR or restricted contexts
    };
    const notify = (name, event, newItem, oldItem)=>{
        const fns = listeners[name];
        if (!fns) return;
        for (const fn of fns)fn(newItem, oldItem, {
            event,
            table: name
        });
    };
    ...
    return {
        ...
        update: async ({ from, data, params })=>{
            const table = getTable(from);
            const updated = [];
            for(let i = 0; i < table.length; i++)if (matchesParams(table[i], params)) {
                const old = {
                    ...table[i]
                };
        ...
        delete: async ({ from, params })=>{
            const table = getTable(from);
            const removed = [];
            for(let i = table.length - 1; i >= 0; i--)if (matchesParams(table[i], params)) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["bnjRI"], null, "parcelRequirefc1b", {})

//# sourceMappingURL=local.05515e5e.js.map
